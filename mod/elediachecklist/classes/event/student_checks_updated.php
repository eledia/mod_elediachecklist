...
/**
 * The mod_elediachecklist student checks updated event.
 *
...
/**
 * The mod_elediachecklist student checks updated class.
 *
 * @package    mod_elediachecklist
 * @since      Moodle 2.7
 * @copyright  2014 Davo Smith <moodle@davosmith.co.uk>
...
class student_checks_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstudentchecksupdated', 'mod_elediachecklist');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/elediachecklist/report.php', array('id' => $this->contextinstanceid,
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'eledia', 'update checks', 'report.php?id='.$this->contextinstanceid.
