...
/**
 * The mod_elediachecklist edit page viewed event.
 *
...
/**
 * The mod_elediachecklist edit page viewed event class.
 *
 * @package    mod_elediachecklist
 * @since      Moodle 2.7
 * @copyright  2014 Davo Smith <moodle@davosmith.co.uk>
...
class edit_page_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventeditpageviewed', 'mod_elediachecklist');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/elediachecklist/edit.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array(
            $this->courseid, 'eledia', 'edit', 'view.php?id='.$this->contextinstanceid,
