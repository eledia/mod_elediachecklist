...
/**
 * The mod_elediachecklist checklist completed event.
 *
...
/**
 * The mod_elediachecklist checklist completed class.
 *
 * @package    mod_elediachecklist
 * @since      Moodle 2.7
 * @copyright  2014 Davo Smith <moodle@davosmith.co.uk>
...
class checklist_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventchecklistcomplete', 'mod_elediachecklist');
    }
    ...
    protected function get_legacy_logdata() {
        return array(
            $this->courseid, 'eledia', 'complete', 'view.php?id='.$this->contextinstanceid,
