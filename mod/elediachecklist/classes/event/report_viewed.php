...
/**
 * The mod_elediachecklist report viewed event.
 *
...
/**
 * The mod_elediachecklist report viewed event class.
 *
 * @package    mod_elediachecklist
 * @since      Moodle 2.7
 * @copyright  2014 Davo Smith <moodle@davosmith.co.uk>
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_elediachecklist');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'eledia', 'report', $url, $this->objectid, $this->contextinstanceid);
    }
