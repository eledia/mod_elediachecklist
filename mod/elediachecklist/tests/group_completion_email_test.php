...
class group_completion_email_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $plugingen = $this->getDataGenerator()->get_plugin_generator('mod_elediachecklist');
        $params = [
    ...
    public function test_group_completion_emails(): void {
        ...
        $items = \mod_elediachecklist\local\checklist_item::fetch_all(['checklist' => $this->checklist->id], true);
