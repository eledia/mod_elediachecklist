...
* 2019-04-26 - Fix bug with autocompletion updating grades during unenrolment. Autocompletion now only updates checkmarks if the user has capability 'mod/elediachecklist:updateown'.
...
* 2012-04-07 - mod/elediachecklist:addinstance capability added (for M2.3); Russian / Ukranian translations from Andriy Semenets
...
2. Upload the files to the your moodle server, placing the 'mod/elediachecklist' files in the '[moodlefolder]/mod/elediachecklist', (optionally) the 'blocks/checklist' files in the '[moodlefolder]/blocks/checklist' folder and (optionally) the 'grade/export/checklist' files in the '[moodlefolder]/grade/export/checklist' folder.
...
==Further information==
Moodle plugins database entry: http://moodle.org/plugins/view.php?plugin=mod_elediachecklist
